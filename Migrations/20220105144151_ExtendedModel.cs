        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SongsWriter = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublishedAlbum", x => new { x.AlbumID, x.PublisherID });
                    table.ForeignKey(
                        name: "FK_PublishedAlbum_Album_AlbumID",
                        column: x => x.AlbumID,
                        principalTable: "Album",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PublishedAlbum_Publisher_PublisherID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublishedAlbum_PublisherID",
                table: "PublishedAlbum",
                column: "PublisherID");
        }
